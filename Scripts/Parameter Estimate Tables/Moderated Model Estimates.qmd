...
table <- parameters %>%
 ...
 # do kable
  ...
  kableExtra::group_rows(
    group_label = 'Pain Interference (BPI)', start_row = 1, end_row = 6,italic = TRUE, bold = FALSE) %>%
  kableExtra::group_rows(
    group_label = 'Pain Severity (BPI)', start_row = 7, end_row = 12,italic = TRUE, bold = FALSE) %>%
  kableExtra::group_rows(
