...
table <- fitIndices %>%
 ...
 # do kable
  ...
  kableExtra::group_rows(
    ...
    group_label = 'Unmoderated', start_row = 1, end_row = 5,italic = TRUE, bold = FALSE) %>%

  kableExtra::group_rows(

    group_label = 'Moderated', start_row = 6, end_row = 10,italic = TRUE, bold = FALSE) %>%
